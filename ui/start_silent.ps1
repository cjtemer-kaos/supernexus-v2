...
$ViteArgs = "-NoProfile", "-WindowStyle", "Hidden", "-Command", "Set-Location '$PSScriptRoot'; npm run dev:renderer"
...
$ElectronArgs = "-NoProfile", "-WindowStyle", "Hidden", "-Command", "Set-Location '$PSScriptRoot'; node node_modules\electron\cli.js ."
