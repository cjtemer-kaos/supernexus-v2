...
class TimeoutManager:
    ...
    def __init__(self, config: Optional[TimeoutConfig] = None):
        ...
        self._timeouts: Dict[str, float] = {
            ...
            "Remote Node_remote": self.config.Remote Node_remote,
...
class SafetyManager:
    ...
    def __init__(self):
        ...
        self.circuit_breakers: Dict[str, CircuitBreaker] = {
            ...
            "Remote Node": CircuitBreaker("Remote Node"),
    ...
    def get_status(self) -> Dict:
        return {
            ...
            "timeouts": {
                ...
                for service in [
                    "ollama_chat", "ollama_vision", "Remote Node_remote", "http_request"
                ]
            },
            "fallback_chains": {
                task_type: {
