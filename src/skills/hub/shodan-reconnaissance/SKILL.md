...
shodan honeyscore ${REMOTE_NODE_IP}
...
shodan scan submit ${REMOTE_NODE_IP}

# Scan with verbose output (shows scan ID)
shodan scan submit --verbose ${REMOTE_NODE_IP}

# Scan and save results
shodan scan submit --filename scan_results.json.gz ${REMOTE_NODE_IP}
```
...
shodan search 'net:${REMOTE_NODE_IP}/24'

# Get port distribution
shodan stats --facets port 'net:${REMOTE_NODE_IP}/24'

# Find specific vulnerabilities in range
shodan search 'net:${REMOTE_NODE_IP}/24 vuln:CVE-2021-44228'

# Export all data for range
shodan download network_scan.json.gz 'net:${REMOTE_NODE_IP}/24'
```
