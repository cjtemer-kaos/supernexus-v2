...
```
${USER_HOME}\skills\skill-installer\
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --source "<caminho-da-skill-criada>" --force
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --source "<caminho>" [--name "nome-override"] [--force]
```

## Cenario 3: Simular Instalacao Sem Fazer Nada (Dry-Run)

```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --source "<caminho>" --dry-run
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --detect
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --detect --auto
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --uninstall "nome-da-skill"
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --health
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --health --repair
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --rollback "nome-da-skill"
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --reinstall-all
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --status
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --log
python ${USER_HOME}\skills\skill-installer\scripts\install_skill.py --log 50
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\validate_skill.py "C:\caminho\para\skill"
python ${USER_HOME}\skills\skill-installer\scripts\validate_skill.py "C:\caminho\para\skill" --strict
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\detect_skills.py
python ${USER_HOME}\skills\skill-installer\scripts\detect_skills.py --path "C:\diretorio\especifico"
python ${USER_HOME}\skills\skill-installer\scripts\detect_skills.py --all
```
...
```bash
python ${USER_HOME}\skills\skill-installer\scripts\package_skill.py --source "C:\caminho"
python ${USER_HOME}\skills\skill-installer\scripts\package_skill.py --all
python ${USER_HOME}\skills\skill-installer\scripts\package_skill.py --all --output "${USER_HOME}\Desktop"
```

## Verificar Integridade De Zips Existentes

```bash
python ${USER_HOME}\skills\skill-installer\scripts\package_skill.py --verify
python ${USER_HOME}\skills\skill-installer\scripts\package_skill.py --verify --output "${USER_HOME}\Desktop"
```
