...
```bash
python ${USER_HOME}\skills\claude-monitor\scripts\health_check.py
```
...
```bash
python ${USER_HOME}\skills\claude-monitor\scripts\health_check.py --browsers-detail
```
...
```bash
python ${USER_HOME}\skills\claude-monitor\scripts\monitor.py --interval 30 --duration 300
```
...
```bash
python ${USER_HOME}\skills\claude-monitor\scripts\api_bench.py
```
