...
nmap -p 443 ${REMOTE_NODE_IP}

# Test SSL connection
openssl s_client -connect ${REMOTE_NODE_IP}:443

# Check certificate
curl -kv https://${REMOTE_NODE_IP}
```
...
```bash
# Basic SNMP walk
snmpwalk -c public -v1 ${REMOTE_NODE_IP}

# Enumerate system info
snmpwalk -c public -v1 ${REMOTE_NODE_IP} 1.3.6.1.2.1.1

# Get running processes
snmpwalk -c public -v1 ${REMOTE_NODE_IP} 1.3.6.1.2.1.25.4.2.1.2

# SNMP check tool
snmp-check ${REMOTE_NODE_IP} -c public

# Brute force community strings
onesixtyone -c /usr/share/seclists/Discovery/SNMP/common-snmp-community-strings.txt ${REMOTE_NODE_IP}
```
...
smbclient -L //${REMOTE_NODE_IP} -N

# Connect to share
smbclient //${REMOTE_NODE_IP}/share -N

# Enumerate with smbmap
smbmap -H ${REMOTE_NODE_IP}

# Full enumeration
enum4linux -a ${REMOTE_NODE_IP}

# Check for vulnerabilities
nmap --script smb-vuln* ${REMOTE_NODE_IP}
```
