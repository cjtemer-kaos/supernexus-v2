...
```
${USER_HOME}\skills\junta-leiloeiros\
├── scripts/
│   ├── scraper/
...
```bash
pip install -r ${USER_HOME}\skills\junta-leiloeiros\scripts\requirements.txt
...
python ${USER_HOME}\skills\junta-leiloeiros\scripts\run_all.py

## Estados Específicos

python ${USER_HOME}\skills\junta-leiloeiros\scripts\run_all.py --estado SP RJ MG

## Ver O Que Seria Coletado Sem Executar

python ${USER_HOME}\skills\junta-leiloeiros\scripts\run_all.py --dry-run

## Controlar Paralelismo (Default: 5)

python ${USER_HOME}\skills\junta-leiloeiros\scripts\run_all.py --concurrency 3
```

## Estatísticas Por Estado

python ${USER_HOME}\skills\junta-leiloeiros\scripts\db.py

## Sql Direto

sqlite3 ${USER_HOME}\skills\junta-leiloeiros\data\leiloeiros.db \
...
```bash
python ${USER_HOME}\skills\junta-leiloeiros\scripts\serve_api.py
...
```bash
python ${USER_HOME}\skills\junta-leiloeiros\scripts\export.py --format csv
python ${USER_HOME}\skills\junta-leiloeiros\scripts\export.py --format json
python ${USER_HOME}\skills\junta-leiloeiros\scripts\export.py --format all
python ${USER_HOME}\skills\junta-leiloeiros\scripts\export.py --format csv --estado SP
```
...
```python
import sys
sys.path.insert(0, r"${USER_HOME}\skills\junta-leiloeiros\scripts")
