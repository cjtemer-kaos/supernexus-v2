...
Searches for biological pathways in Pathway Commons (Remote Node). Use this tool to find pathways related...
...
.. dropdown:: pc_search_pathways tool specification
   ...
   * **Type**: ``PathwayCommonsTool``
   * **Description**: Searches for biological pathways in Pathway Commons (Remote Node). Use this tool to find pathways related to specific keywords, such as 'p53' or 'apoptosis'.
