...
class SkillRegistry:
    ...
    def __init__(self, registry_dir: Path = Path(os.environ.get("SKILLS_CATALOG_PATH", "")), skills_root: Optional[str] = None, index_path: Optional[str] = None, node_id: str = "default"):
        if skills_root:
    ...
    def get_stats(self) -> Dict:
        """Alias para consistencia con otros registries."""
