...
class SocialHub:
    ...
    def __init__(self, whatsapp_script: str = None, discord_script: str = None):
        if sys.platform == "win32":
            ...
            self.whatsapp_script = whatsapp_script or str(Path(_root) / "src" / "integrations" / "whatsapp_bot.py")
            self.discord_script = discord_script or str(Path(_root) / "src" / "integrations" / "discord_bot_v2.py")
