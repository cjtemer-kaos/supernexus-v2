...
Entre Windows y REMOTE (y futuras maquinas via Tailscale).
"""
...
class MemorySync:
    ...
    Bidireccional: Windows <-> REMOTE <-> Tailscale nodes.
    """
    ...
    def __init__(self, local_db: Optional[str] = None, remote_url: Optional[str] = None):
        ...
        self.remote_url = remote_url or f"http://{os.getenv('SUPER_NEXUS_REMOTE_IP', 'localhost')}:9000"
