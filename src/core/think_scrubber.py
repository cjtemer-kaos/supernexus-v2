"""
Streaming Think Scrubber — Stateful reasoning-block suppression for streaming.

Absorbed from hermes-agent. Handles `<think>`, `<thinking>`, `<reasoning>`,
`<thought>`, `<REASONING_SCRATCHPAD>` tags. Partial tags at delta boundaries
are held back until resolved. Prevents reasoning leaks in streaming output.
