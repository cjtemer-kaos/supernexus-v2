...
- Fallback automático: si Remote Node no responde → usar local, si local falla → usar cloud
...
class ResilienceLayer:
    ...
    Uso:
        ...
        result = await resilience.execute_with_fallback(
            task=my_task,
            engines=["nexus_Remote Node", "nexus_master", "openclaw_gateway"]
        )
    """
    ...
    def __init__(self):
        ...
        self._fallback_chain: Dict[str, List[str]] = {
            "nexus_Remote Node": ["nexus_master", "openclaw_gateway"],
            "nexus_master": ["nexus_Remote Node", "openclaw_gateway"],
            "openclaw_gateway": ["nexus_master", "nexus_Remote Node"],
        }
