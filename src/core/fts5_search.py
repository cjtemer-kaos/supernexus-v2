...
class FTS5Search:
    ...
    def index_cognitive_memory(self, memory_id: str, content: str, metadata: Dict = None):
        """Indexa una memoria cognitiva"""
        self.index_document(memory_id, "cognitive_memories", content, metadata)
