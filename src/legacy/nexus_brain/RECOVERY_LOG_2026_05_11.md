...
### Solution Approach
Used baseline distributions as reference to restore proper architecture:
...
- ✅ PC2 SSH - configure IP in env (user, password-redacted, sudo)
...
**PC2 Bridge**: ✅ Available (configure IP in env)  
