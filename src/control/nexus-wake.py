...
for t in targets:
    ...
    if count > 0:
        ...
        AGENT_SCRIPTS = {
            "qwen-code": "qwen_autonomous_loop.py",
            "hermes-code": "hermes_autonomous_loop.py",
            "zero-code": "zero_autonomous_loop.py",
            "aider-code": "aider_autonomous_loop.py",
            "openclaw": "openclaw_autonomous_loop.py",
        }
        script_name = AGENT_SCRIPTS.get(t, "nexus_autonomous_loop.py")
        script = os.path.join(os.path.dirname(__file__), "..", "agents", script_name)
